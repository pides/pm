    ...
    <div class="window" id="window">
        <div class="iframe">
            <div class="header">
                ...
                <div class="tab-list" id="test">
                    <ul class="tab-slide" data-deviation="">
                        <li class="item active tagSign"><span><label>全部用户111111111111111</label></span><i class="tri"></i></li>
                ...
                <div class="btn-form">
                    <div class="btn-left pic-angle-left" data-id='left'></div>
                    <div class="btn-right pic-angle-right" data-id='right'></div>
                </div>
            </div>
            <div class="menu">
                <ul>
